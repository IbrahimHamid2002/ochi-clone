...
function Footer() {
    return (
        <div className='w-full h-screen rounded-tr-3xl rounded-tl-3xl pt-16 pb-10 px-12 flex gap-5'>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className='heading'>
                    <h1 className='text-[9vw] font-primary leading-none -mb-6'>EYE-</h1>
                    <h1 className='text-[9vw] font-primary leading-none -mb-6'>OPENING</h1>
                </div>
            ...
            <div className='w-1/2 h-full'>
                <div className='heading'>
                    <h1 className='text-[9vw] font-primary leading-none -mb-6'>PRESENTATIONS</h1>
                </div>
                <div className="l1 w-full flex flex-col gap-1 font-secondary">
                    <h1 className='mt-10 mb-4'>S:</h1>
                    {["Instagram", "Facebook", "Behance", "LinkedIn"].map((item, index) => (
                        <a key={index} href="#">{item}</a>
                    ))}
                </div>
                <div className="l2 w-full flex justify-between font-secondary">
                    <div className="left w-[20%] flex flex-col gap-5">
                        <h1 className='mt-7 mb-2'>L:</h1>
                        {["202-1965 W 4th Ave Vancouver, Canada", "30 Chukarina St Lviv, Ukraine"].map((item, index) => (
                            <a key={index} href="#">{item}</a>
                        ))}
                    </div>
                    <div className="right w-[20%] flex flex-col">
                        <h1 className='mt-7 mb-2'>M:</h1>
